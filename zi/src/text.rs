...
pub trait AnyTextSlice<'a>: TextBase {
    ...
    fn dyn_slice(&self, byte_range: (Bound<usize>, Bound<usize>))
    ...
    T: TextSlice<'a> + 'a,
{
    ...
    fn dyn_slice(
        ...
        Box::new(<T as TextSlice<'a>>::slice(self, byte_range))
    }
