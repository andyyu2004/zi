...
use zi_editor::tree_sitter::{
    self, InputEdit, Node, Parser, Query, QueryCapture, QueryCaptures, QueryCursor, Tree,
};
use zi_editor::{
    dirs, AnyText, AnyTextMut, AnyTextSlice, Delta, Deltas, FileType, Point, PointRange, Text,
    TextMut, TextSlice,
};

impl zi_editor::Syntax for Syntax {
    #[inline]
    fn file_type(&self) -> zi_editor::FileType {
        self.file_type
    }
