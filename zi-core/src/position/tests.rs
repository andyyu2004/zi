...
fn range_merge_iter() {
    ...
    check([("1:1..1:5", "fg=#000102")], [("1:2..1:2", "bg=#010203")], expect![[r#"
            1:1..1:2 => fg=#000102
            1:2..1:5 => fg=#000102
        "#]]);

    check([("1:1..1:5", "fg=#000102")], [("1:1..1:5", "bg=#010203")], expect![[r#"
            1:1..1:5 => fg=#000102 bg=#010203
        "#]]);

    check([("1:1..1:5", "fg=#000102")], [("1:1..1:6", "bg=#010203")], expect![[r#"
            1:1..1:5 => fg=#000102 bg=#010203
            1:5..1:6 => bg=#010203
        "#]]);

    check([("1:1..1:5", "fg=#000102")], [("1:2..1:6", "bg=#010203")], expect![[r#"
            1:1..1:2 => fg=#000102
            1:2..1:5 => fg=#000102 bg=#010203
            1:5..1:6 => bg=#010203
        "#]]);

    check([("1:2..1:5", "fg=#000102")], [("1:1..1:6", "bg=#010203")], expect![[r#"
            1:1..1:2 => bg=#010203
            1:2..1:5 => fg=#000102 bg=#010203
            1:5..1:6 => bg=#010203
        "#]]);

    check([("1:2..1:10", "fg=#000102")], [("1:1..1:6", "bg=#010203")], expect![[r#"
            1:1..1:2 => bg=#010203
            1:2..1:6 => fg=#000102 bg=#010203
            1:6..1:10 => fg=#000102
        "#]]);

    check([("1:2..1:10", "fg=#000102")], [("1:2..1:10", "bg=#010203")], expect![[r#"
    ...
    check([("1:1..1:4", "fg=#123456"), ("1:6..1:10", "fg=#abcdef")], [], expect![[r#"
            1:1..1:4 => fg=#123456
            1:6..1:10 => fg=#abcdef
        "#]]);
